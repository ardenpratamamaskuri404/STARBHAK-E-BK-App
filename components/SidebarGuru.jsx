...
export default function SidebarGuru() {
  ...
  const menuItems = [
    { name: "Dashboard", href: "/gurubk/home", icon: Home },
    { name: "Pengajuan", href: "/gurubk/pengajuan", icon: Inbox },
    { name: "Jadwal", href: "/gurubk/jadwal", icon: Calendar },
    { name: "Catatan", href: "/gurubk/catatan", icon: NotebookPen },
    { name: "Riwayat", href: "/gurubk/riwayat", icon: History },
    { name: "Statistik", href: "/gurubk/dashboard", icon: LayoutDashboard },
  ];
      ...
      <div className={`flex items-center ${collapsed ? "justify-center" : "justify-between"} p-4 border-b border-gray-100`}>
        {!collapsed && (
          <Link href="/gurubk/home" className="flex items-center gap-3">
            ...
            <span className="text-lg font-bold text-[#0046FF]">Guru E-BK</span>
          </Link>
        )}
        {collapsed && (
          <img src="/logo-tb.png" className="w-9 h-9" alt="Logo" />
          ...
          >
            ...
            {!collapsed && (
              <div className="flex-1 text-left min-w-0">
                <p className="text-sm font-semibold text-gray-900 truncate">{session?.user?.name || "Guru BK"}</p>
                <p className="text-xs text-gray-500 truncate">Guru Bimbingan Konseling</p>
              </div>
            )}
          </button>
